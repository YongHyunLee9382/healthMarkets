package com.spring.healthMarkets.order.dto;
...
public class OrderDTO {
	...
	public String toString() {
		return "OrderDTO [orderCd=" + orderCd + ", memberId=" + memberId + ", productCd=" + productCd
				+ ", orderGoodsQty=" + orderGoodsQty + ", paymentAmt=" + paymentAmt + ", ordererNm=" + ordererNm
				+ ", ordererHp=" + ordererHp + ", receiverNm=" + receiverNm + ", receiverHp=" + receiverHp
				+ ", zipcode=" + zipcode + ", roadAddress=" + roadAddress + ", jibunAddress=" + jibunAddress
				+ ", namujiAddress=" + namujiAddress + ", deliveryMethod=" + deliveryMethod + ", deliveryMessage="
				+ deliveryMessage + ", deliveryStatus=" + deliveryStatus + ", giftWrapping=" + giftWrapping
